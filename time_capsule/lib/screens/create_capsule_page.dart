...
class _CreateCapsulePageState extends State<CreateCapsulePage> {
  ...
  Future<void> _createCapsule() async {
    ...
    try {
      ...
      // Use MediaService to save the capsule
      final success = await mediaService.saveCapsule(
        title: title,
                          ...
                          children: [
                            ...
                            TextField(
                              ...
                              decoration: const InputDecoration(
                                ...
                                hintText:
                                    'Add some details about this collection',
      ...
      bottomNavigationBar: Container(
        ...
        child: SafeArea(
          child: ElevatedButton(
            onPressed: _isSaving ? null : _createCapsule,
            style: ElevatedButton.styleFrom(
